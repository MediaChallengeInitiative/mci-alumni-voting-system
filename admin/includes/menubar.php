  ...
  <section class="sidebar">
    ...
    <div class="user-panel">
      <div class="pull-left image">
        <?php
          $sidebarPhoto = (isset($user['photo']) && !empty($user['photo'])) ? '../images/'.$user['photo'] : '../images/profile.jpg';
          $sidebarName = (isset($user['firstname']) ? htmlspecialchars($user['firstname']) : 'Admin') . ' ' . (isset($user['lastname']) ? htmlspecialchars($user['lastname']) : '');
        ?>
        <img src="<?php echo $sidebarPhoto; ?>" class="img-circle" alt="User Image">
      </div>
      <div class="pull-left info">
        <p><?php echo $sidebarName; ?></p>
